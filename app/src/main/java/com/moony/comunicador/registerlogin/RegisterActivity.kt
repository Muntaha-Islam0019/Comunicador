...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*Check drawables for how to make something round.*/
        ...
        /*I've used circleimageview library here.*/
    ...
    private fun saveUserToFirebaseDatabase(profileImageUrl: String) {
        ...
        ref.setValue(user)
            .addOnSuccessListener {
                ...
                /*Clears unused activities from stack.
                 * Without using this, when user is in his/her messages page,
                 * if he presses back button,
                 * then he/she will go back to the register or login activity.*/
